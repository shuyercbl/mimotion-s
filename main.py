...
min_dict = {time_list[0]: 1000, time_list[1]: 7001, time_list[2]: 10500, time_list[3]: 20000, time_list[4]: 30010, time_list[5]: 45000, time_list[6]: 50001}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 2000, time_list[1]: 8500, time_list[2]: 10900, time_list[3]: 30000, time_list[4]: 40900, time_list[5]: 49999, time_list[6]: 54000}
# 设置结束
